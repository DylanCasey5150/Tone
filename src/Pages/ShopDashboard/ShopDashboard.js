...
import Dropdown from "../Dropdown_Menu/Dropdown_Menu.js";
        ...
        <div className="Nav_Wheel">
          <div className="donut-chart-block block">
            <div className="donut-chart">
              <div
                onClick={this.changeState.bind(null, MENU_ONE)}
                id="part1"
              ...
              <div
                onClick={this.changeState.bind(null, MENU_TWO)}
                id="part2"
                className="portion-block"
              >
                {" "}
              ...
              <div
                onClick={this.changeState.bind(null, MENU_THREE)}
                id="part3"
                className="portion-block"
              >
                {" "}
